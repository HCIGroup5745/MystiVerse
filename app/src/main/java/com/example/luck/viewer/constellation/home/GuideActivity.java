package com.example.luck.viewer.constellation.home;
...
import com.example.luck.viewer.constellation.MainActivityViewer;
    ...
    private void setListener() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GuideActivity.this, MainActivityViewer.class);
